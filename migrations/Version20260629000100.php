...
final class Version20260629000100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE countrys (id UUID NOT NULL, iso_code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX uniq_country_iso ON countrys (iso_code)');
        $this->addSql('CREATE TABLE citys (id UUID NOT NULL, country_id UUID NOT NULL, name VARCHAR(255) NOT NULL, region VARCHAR(255) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX idx_city_country ON citys (country_id, name)');
    ...
    {
        foreach (['request_logs','usages','proxy_nodes','exit_nodes','citys','countrys','proxy_credentials','subscriptions','api_keys','users','plans'] as $table) {
